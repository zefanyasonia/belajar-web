    ...
    <div class="container" style="margin-top: 50px">
        ...
        <form class="form-horizontal" method="post" action="index.php">
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <input type="text" name="nama" class="form-control" placeholder="Tutorialweb" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">EMAIL</label>
                <div class="col-sm-4">
                    <input type="email" name="email" class="form-control" placeholder="support@tutorialweb.net" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">WEBSITE</label>
                <div class="col-sm-4">
                    <input type="url" name="website" class="form-control" placeholder="http://tutorialweb.net">
                </div>
            </div>
			<div class="form-group">
                <label class="col-sm-2 control-label">JUDUL PESAN</label>
                <div class="col-sm-6">
                    <input type="text" name="judul" class="form-control" placeholder="Senang banget dengan tutorialweb.net" required>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">Saran</label>
                <div class="col-sm-8">
                    <textarea name="pesan" class="form-control" placeholder="Hai, saya sangat senang dengan tutorial yang ada di tutorialweb.net. Terima kasih." required></textarea>
                </div>
            </div>
            <div class="form-group">
        ...
        $pesan      = $koneksi->real_escape_string($_POST['saran']);
        $tanggal    = date('Y-m-d');
